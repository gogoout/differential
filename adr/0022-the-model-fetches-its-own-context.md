...
Extended by [0032](0032-what-makes-an-agent-supportable.md), which adds four more
...
- The default backend gains a read-only allowlist (which ADR 0032 later found needed
